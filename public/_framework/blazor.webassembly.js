        ...
        (e.jsCallDispatcher = {
          ...
          beginInvokeJSFromDotNet: function (e, t, n) {
            ...
            e &&
              r.then(
                function (t) {
                  return c().endInvokeJSFromDotNet(
                    e,
                    !0,
                    JSON.stringify([e, !0, t], m),
                  );
                },
                function (t) {
                  return c().endInvokeJSFromDotNet(
              ...
              (delete d[t],
                u
                  ? (function (e, t) {
                      ...
                      for (
                        var r = a.getLogicalChildrenArray(n),
                          o = r.indexOf(e) + 1,
                          i = r.indexOf(t),
                          u = o;
                        u <= i;
            ...
            for (
              ...
              switch (g) {
                ...
                case r.EditType.removeAttribute:
                  ...
                  _ = d.siblingIndex(b);
                  if (
                    !((C = a.getLogicalChild(n, l + _)) instanceof HTMLElement)
                  )
                    throw new Error(
                      "Cannot remove attribute from non-element child",
                    );
                  var I = d.removedAttributeName(b);
                  this.tryApplySpecialProperty(e, C, I, null) ||
                    C.removeAttribute(I);
                  break;
              ...
              case "OPTION":
                ...
                return (
                  i &&
                    ...
                    (this.tryApplyValueProperty(e, i, n),
          ...
          switch (t.type) {
            ...
            case "drop":
              return new e(
                "drag",
                (function (e) {
                  return r(r({}, a(e)), { dataTransfer: e.dataTransfer });
                })(t),
              );
            case "focus":
            case "blur":
        ...
        return o(this, function (g) {
          switch (g.label) {
            ...
            case 1:
              return (
                ...
                [
                  4,
                  Promise.all([
                    d.WebAssemblyResourceLoader.initAsync(
                      n.bootConfig,
                      e || {},
                    ),
                    p.WebAssemblyConfigLoader.initAsync(n),
                  ]),
                ]
              );
            case 2:
            ...
            case 5:
              throw (
                (y = g.sent()),
                new Error("Failed to start platform. Reason: " + y)
              );
            case 6:
              ...
              ((window.Module = (function (e, t, n) {
                ...
                return (
                  ...
                  f.preRun.push(function () {
                    ((a = cwrap("mono_wasm_add_assembly", null, [
                      "string",
                      "number",
                      "number",
                    ])),
                  ...
                  f.postRun.push(function () {
                    ...
                    (e.bootConfig.debugBuild &&
                      ...
                      cwrap("mono_wasm_load_runtime", null, [
                        "string",
                        "number",
                      ])("appBinDir", i.hasDebuggingEnabled() ? -1 : 0),
          ...
          (e.prototype.logToConsole = function () {
            ...
            if (0 !== o) {
              ...
              (console.groupCollapsed(
                "%cblazor%c Loaded " + c(o) + " resources" + a,
            ...
            return r(this, void 0, void 0, function () {
              ...
              return o(this, function (o) {
                switch (o.label) {
                  ...
                  case 1:
                    return (s = o.sent())
                      ? ((c = parseInt(s.headers.get("content-length") || "0")),
                ...
                switch (o.label) {
                  ...
                  case 1:
                    return (
                      ...
                      (this.networkLoads[t] = { responseBytes: u }),
                      [
                        4,
                        e.put(
                          n,
